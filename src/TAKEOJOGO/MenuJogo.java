     ...
     case 3:
       ...
       break;
                ...
                do{    
                    ...
                    System.out.println("O que acontece se você tentar compilar e executar o seguinte codigo?\n" +
"\n" +
...
"    }\n" +
"}");
                    System.out.println("1) O codigo compila e imprime 10.");
                    System.out.println("2) O codigo compila e imprime 0.");
                    System.out.println("3) O codigo compila, mas resulta em uma exceção de divisao por zero durante a execucao.");
                    System.out.println("4) O codigo não compila devido a um erro na linha int resultado = x / y;.");
     ...
     case 2:
       ...
       break;
     case 3:
       System.out.println("Seu intelecto e mais amplo do que imaginei.. continue zero vamos ver ate onde você vai chegar");
         System.out.println("");
       break;
       case 4:
       System.out.println("ERROU");
...
"}");
                    ...
                    System.out.println("2) Cria uma excecao de ArrayIndexOutOfBounds.");
            ...
            case 1:
                ...
                System.out.println("Zero, Zero, Zero voce e realmente um cara intrigante... vamos ver se consegue acertar a proxima!.");
                break;
     ...
     case 3:
       ...
       break;
                                ...
                                do{        
                System.out.println("Faca sua escolha " + "Zero");
               
               
                   
                    System.out.println(" pergunta 4 \n" + "Red Matrix: Zero.. esta e sua penultima questão estou intrigado com sua inteligencia... \n"+
                            "public class Mediana {\n" +
"    public static void main(String[] args) {\n" +
"        int[] numeros = {4, 7, 2, 9, 5, 1, 8, 3, 6};\n" +
"        int mediana = calcularMediana(numeros);\n" +
"        System.out.println(\"A mediana do array e: \" + mediana);\n" +
"    }\n" +
"\n" +
...
"}");
     ...
     case 2:
       ...
       break;
     case 3:
       System.out.println("PARABENS VOCE VENCEU A MATRIX!" + cor);
       break;
     }
                ...
                }else System.out.println("Blue Matrix: Ola Zero eu sou a I.A desta Matrix e irei testar seu intelecto com perguntas de Matematica! Voce \n" + "deve selecionar uma das alternativas abaixo, se errar... bom deixarei você descobrir o resultado por si só (R.I.P)");
                
                System.out.println("Faça sua escolha " + nome);
               
               
                   do{
                    System.out.println(" pergunta 1: Qual é o resultado da expressao \n" +
"3 x(4+2)−5? ");
                    System.out.println("1) 10");
                    System.out.println("2) 15");
     ...
     case 3:
       ...
       break;
                   ...
                   }while(bluequestao1 != 3);
                
               
                do{    
                    System.out.println("Simplifique a expressao \n" +
"8−(2 x 3)+5.");
                ...
                do{        
                System.out.println("Blue Matrix: Interessante.. me surpreenda! Zero.");
            ...
            case 1:
                ...
                System.out.println("Blue Matrix: Seu intelecto e mais amplo do que imaginei.. continue zero vamos ver ate onde você vai chegar. \n");
                break;
     ...
     case 3:
       ...
       break;
                                ...
                                do{        
                System.out.println("Red Matrix: Zero.. esta é sua penultima questao estou intrigado com sua inteligencia...");
               
               
                   
                    System.out.println(" pergunta 4: Resolva a expressao \n" +
" 16+3 x 2−5.");
            ...
            case 1:
                ...
                System.out.println("Blue Matrix: Reta final Zero! sua ultima questão e irei conceder sua liberdade");
                break;
     ...
     case 3:
       ...
       break;
            ...
            case 1:
                ...
                System.out.println("Blue Matrix: Parabéns Zero! Você venceu esta Matrix ");
                break;
